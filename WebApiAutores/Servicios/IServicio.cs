namespace WebApiAutores.Servicios
{
    ...
    //DISTINTOS SERVICIOS:
    // AddTransient == Agregar un transitorio, se nos va a dar una nueva instancia de la clase
    // AddScope == siempre misma instancia en el mismo contexto http
    // AdSingleton == siempre la misma instancia con distintas peticiones y usuarios distintos
